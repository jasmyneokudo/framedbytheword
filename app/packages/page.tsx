...
const PACKAGES: Pkg[] = [
  {
    ...
    totalFrames: "6–7 premium frames",
    icon: Leaf,
    highlights: [
      "Pre-curated scripture catalog",
      "Standard A2 / A3 sizes",
      "Virtual design consultation",
    ],
    inclusions: [
      "Living room — 1 statement piece",
      "Dining area — 1 piece",
      "Master bedroom — 1 piece",
      "4 other bedrooms — 1 frame per room",
      "Soft, elegant color coordination",
      "Step-by-step installation guide (PDF + video)",
      "Frame placement layout guide",
    ],
    installation:
      "Guided self-installation included. White-glove on-site installation available as an upgrade (₦250,000 – ₦450,000).",
    valueAdds: [
  ...
  },
  {
    ...
    price: "₦1,500,000 – ₦2,200,000",
    totalFrames: "10–14 frames",
    icon: Sparkles,
    featured: true,
    highlights: [
      "Custom scripture curation",
      "Mixed A1 / A2 / A3 sizing",
    ...
    inclusions: [
      ...
      "Entrance / passage — 1 feature piece",
      "Custom curation based on family values & lifestyle",
      "Color palette tailored per room",
      "On-site styling & arrangement refinement",
    ],
    installation:
      "Professional installation included. Priority production timeline.",
    valueAdds: [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Premium finishes & museum-quality glass",
      "Advanced mockups & presentation",
    ],
    inclusions: [
      "Living room — luxury gallery wall (3–5 pieces)",
      "Dining — 1 large statement piece",
      "All 5 bedrooms — 2–3 curated pieces per room",
      "Entrance — 1–2 premium statement frames",
      "Passageways / hallways — 2–4 complementary frames",
      "Thematic flow: peace, prosperity, protection, legacy",
      "Wood textures, gold accents, A0 / A1 / custom sizing",
      "On-site consultation & measurements",
    ],
    installation:
      "White-glove installation experience with post-install styling adjustments.",
    valueAdds: [
      "Strong visual impact in transitional spaces",
      "Luxury, gallery-style finishing",
      "Highly personalized spiritual storytelling",
      "Post-install styling adjustments",
    ],
  },
];
